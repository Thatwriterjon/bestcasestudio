...
}, "/Users/jon/bestcasestud.io/src/components/Icons/ArticleIcon.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/src/components/Icons/VideoIcon.astro", void 0);
...
const $$ArticleCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Card", $$Card, { "isUnderline": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<article class="p-6"> <div class="flex justify-between items-center mb-5 text-gray-500"> <span class="bg-yellow text-black text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded"> ${article.data.type == "Article" ? renderTemplate`${renderComponent($$result2, "ArticleIcon", $$ArticleIcon, {})}` : renderTemplate`${renderComponent($$result2, "VideoIcon", $$VideoIcon, {})}`} ${article.data.type} </span> <span class="text-sm">${formatDate(article.data.pubDate)}</span> </div> <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">${article.data.title}</h2> <p class="mb-5 font-light text-gray-500" style="white-space: pre-line">${article.data.summary}</p> <div class="flex justify-between items-center"> <div class="flex items-center space-x-4"> <img class="w-7 h-7 rounded-full"${addAttribute(article.data.authImage, "src")}${addAttribute(article.data.author + " cover", "alt")}> <span class="font-medium"> ${article.data.author} </span> </div> <a${addAttribute("/articles/" + article.slug, "href")} class="inline-flex items-center font-medium text-black hover:text-pink">
Read more
...
}, "/Users/jon/bestcasestud.io/src/components/ui/ArticleCard.astro", void 0);
