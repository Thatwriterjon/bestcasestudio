...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const socials = [
    ...
    { name: "Spotify", href: "https://open.spotify.com/show/6mH42FJY0OA3CNiMAIj4cN", label: "Best Case Studio on Spotify" },
    { name: "Apple Podcasts", href: "https://podcasts.apple.com/us/podcast/saasy-as-f-k-podcast/id1573388272", label: "Best Case Studio on Apple Podcasts" }
  ];
  return renderTemplate`${maybeRenderHead()}<section class="sm:px-5"> <div class="w-full max-w-[1240px] mx-auto"> <div class="px-[15px] bg-dark text-gray py-[55px] lg:px-[60px] sm:rounded-t-[45px]"> <!-- Top row: logo | nav links | social links --> <div class="flex flex-col lg:flex-row gap-7 items-center justify-between"> <picture> <a href="#home"> ${renderComponent($$result, "Image", $$Image, { "src": Logo, "alt": "Best Case Studio logo" })} </a> </picture> <ul class="flex flex-col sm:flex-row gap-5"> ${links.map((link) => renderTemplate`<li class="text-center"> <a class="underline"${addAttribute(link.href, "href")}>${link.name}</a> </li>`)} </ul> <ul class="flex flex-wrap gap-4"> ${socials.map((s) => renderTemplate`<li> <a${addAttribute(s.href, "href")} target="_blank" rel="noopener noreferrer"${addAttribute(s.label, "aria-label")} class="text-xs uppercase tracking-widest text-gray hover:text-pink transition-colors"> ${s.name} </a> </li>`)} </ul> </div> <!-- Divider --> <div class="h-[1px] bg-gray mt-[51px] mb-5"></div> <!-- Copyright row --> <div class="flex justify-center md:justify-between text-center"> <span>© ${(/* @__PURE__ */ new Date()).getFullYear()} Best Case Studio. All rights reserved.</span> </div> </div> </div> </section>`;
}, "/Users/jon/bestcasestud.io/src/components/ui/Footer.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/Astronav.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  const navButton = {
    ...
    label: "Credibility Scorecard",
    target: "_blank",
    rel: "noopener noreferrer"
  };
  return renderTemplate(_a || (_a = __template(["", '<div class="mt-20"> <nav class="w-full top-0 left-0 z-50 fixed bg-white"> <header class="flex flex-col lg:flex-row justify-between items-center my-5 px-6 md:px-32"> ', ' <div> <div class="hidden lg:flex items-center gap-4"> <a class="px-9 py-5 rounded-2xl bg-pink hover:opacity-90 text-black inline-flex"', "", "", '> <h2 class="text-center text-xl font-normal leading-7">', `</h2> </a> </div> </div> </header> </nav> </div> <script>
...
}, "/Users/jon/bestcasestud.io/src/components/seo/Seo.astro", void 0);
...
}, "/Users/jon/bestcasestud.io/src/layouts/MainHead.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-ouamjn2i> ${renderComponent($$result, "MainHead", $$MainHead, { ...props, "data-astro-cid-ouamjn2i": true })}${renderScript($$result, "/Users/jon/bestcasestud.io/src/layouts/MainLayout.astro?astro&type=script&index=0&lang.ts")}${maybeRenderHead()}<body class="bg-white font-grotesk" data-astro-cid-ouamjn2i> <main data-astro-cid-ouamjn2i> ${renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-ouamjn2i": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-ouamjn2i": true })} </main> </body></html>`;
}, "/Users/jon/bestcasestud.io/src/layouts/MainLayout.astro", void 0);
