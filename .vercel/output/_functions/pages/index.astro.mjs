/* empty css                                 */
import { c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as createAstro, d as addAttribute, h as renderScript } from '../chunks/astro/server_DTu46K8G.mjs';
import 'kleur/colors';
import { $ as $$Card } from '../chunks/Card_CxLGULV8.mjs';
import { b as $$Section, c as $$SectionTitle, $ as $$Logos, a as $$Services } from '../chunks/Services_BcWqtplG.mjs';
...
const $$Proposal = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "pricing" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mt-[140px]"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "Pricing & Packages", "description": "One complete case study ecosystem \u2014 video, copy, and social assets. Pick the package that fits." })} <div class="flex flex-col md:flex-row gap-8 mb-20"> <!-- Single tier --> <div class="flex-1 bg-[#F3F3F3] border border-dark shadow-[0px_5px_0px_#191a23] rounded-[45px] p-10 flex flex-col"> <h3 class="text-2xl font-medium mb-4">Single Full-Stack Case Study</h3> <p class="text-4xl font-bold">$3,000</p> <p class="text-sm text-zinc-500 mb-6">per case study</p> <ul class="flex flex-col gap-3 flex-1"> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> 1 video case study</li> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> Short testimonial video</li> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> 5 social videos</li> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> Landing page copy</li> </ul> <p class="text-sm font-medium mt-4">Timeline: 2&ndash;3 weeks</p> <a href="https://calendly.com/thatwriterjon/best-case-studio" class="btn-primary mt-6 inline-block text-center">Book Discovery Call</a> </div> <!-- Trio tier --> <div class="flex-1 bg-yellow border border-dark shadow-[0px_5px_0px_#191a23] rounded-[45px] p-10 flex flex-col"> <h3 class="text-2xl font-medium mb-4">Trio of Full-Stack Case Studies</h3> <p class="text-4xl font-bold">$7,500</p> <p class="text-sm mb-6">$2,500 per case study</p> <ul class="flex flex-col gap-3 flex-1"> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> 3 video case studies</li> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> 3 short testimonial videos</li> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> 15 social videos</li> <li class="flex items-start gap-2"><span class="font-bold">&#10003;</span> 3 &times; landing page copy</li> </ul> <p class="text-sm font-medium mt-4">Timeline: 3&ndash;6 weeks</p> <a href="https://calendly.com/thatwriterjon/best-case-studio" class="btn-primary mt-6 inline-block text-center">Book Discovery Call</a> </div> </div> </div> ` })}`;
}, "/Users/jon/bestcasestud.io/src/components/sections/Proposal.astro", void 0);
...
const $$FAQ = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "faq" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mt-[140px]"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "Frequently Asked Questions", "description": "Everything you need to know before booking a discovery call." })} ${faq.map((item) => renderTemplate`${renderComponent($$result2, "AccordionItem", $$AccordionItem, { "index": item.index, "title": item.title, "description": item.description })}`)} </div> ` })}`;
...
const $$Testimonials = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "testimonials" }, { "default": ($$result2) => renderTemplate(_a || (_a = __template([" ", '<div class="mt-20 mb-[150px]"> ', ` <script type="text/javascript" src="https://testimonial.to/js/iframeResizer.min.js"><\/script> <iframe id="testimonialto-a9a5cbcc-76b3-4896-99d9-f94ed6736bf2" src="https://embed-v2.testimonial.to/carousel/all/best-case-studio?id=a9a5cbcc-76b3-4896-99d9-f94ed6736bf2" frameborder="0" scrolling="no" width="100%" height="450" style="min-height: 450px;"></iframe> <script type="text/javascript">iFrameResize({log: false, checkOrigin: false}, '#testimonialto-a9a5cbcc-76b3-4896-99d9-f94ed6736bf2');<\/script> </div> `])), maybeRenderHead(), renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "What Our Clients Say", "description": "Real feedback from B2B SaaS companies who've worked with Best Case Studio." })) })}`;
}, "/Users/jon/bestcasestud.io/src/components/sections/Testimonials.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Best Case Studio \u2014 B2B SaaS Case Studies", "description": "Best Case Studio creates full-stack case studies for B2B SaaS companies \u2014 video, landing page copy, and social assets \u2014 so your customers sell for you." }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, {})} ${renderComponent($$result2, "Logos", $$Logos, {})} ${renderComponent($$result2, "Services", $$Services, {})} ${renderComponent($$result2, "Proposal", $$Proposal, {})} ${renderComponent($$result2, "Cases", $$Cases, {})} ${renderComponent($$result2, "Team", $$Team, {})} ${renderComponent($$result2, "Testimonials", $$Testimonials, {})} ${renderComponent($$result2, "Referral", $$Referral, {})} ${renderComponent($$result2, "Contact", $$Contact, {})} ${renderComponent($$result2, "FAQ", $$FAQ, {})} ` })}`;
