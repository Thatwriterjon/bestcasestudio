...
import { b as $$Section, c as $$SectionTitle, $ as $$Logos, a as $$Services } from '../chunks/Services_BtLrc8NI.mjs';
...
const $$Cases = createComponent(($$result, $$props, $$slots) => {
  const steps = [
    ...
    },
    {
      ...
      description: "We edit the video into multiple lengths for different uses, write a landing page for your website, and produce a shareable PDF."
    },
    {
      index: 3,
